        ...
        >
            <div className={classes.aboutUsTextBlock}>
                <div className={classes.aboutUsDesc}>
                    ...
                    منذ أكثر من سنة ونصف في "عطاء", أخذنا على عاتقنا تنفيذ العقائق والنذور والصدقات والأضاحي بكل أمانة وسهولة, بفضل الله وثقة عملائنا, نفذنا أكثر من 1500 طلب , وحرصنا دائمًا أن نكون حلقة وصل بين الخير ومستحقيه                    </div>
                </div>
