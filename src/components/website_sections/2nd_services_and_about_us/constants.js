...
export const serviceCards = [
    ...
    {   
        ...
        id: 2, title: " اضــــاحى", 
        brief: " عيدك غير معانا! قدم أضحيتك بسهولة واحنا نوصلها للي يستحقها كاملة، وتاخذ الأجر بإذن الله" , 
        price: "Free",
...
export const values = [
    ...
    {   id: 3,  symbol: giftboxLogo, title: "الثقة",
        desc: ["أكثر من 2000 عميل وضعوا ثقتهم بنا، والتزامنا بالشفافية والمصداقية هو أساس نجاحن"]
    }, 
