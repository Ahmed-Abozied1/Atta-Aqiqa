...
export const ConsultationRequestForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    emailjs
      .send(
        "service_aar0anj",       // ← Replace with your actual Service ID
        "template_jd2m1f2",      // ← Replace with your actual Template ID
        templateParams,
        "OCJ37qJaz_ETxtjNC"      // ← Replace with your actual Public Key
      )
      .then(() => {
        setName("");
        setIsNameEmpty(true);
